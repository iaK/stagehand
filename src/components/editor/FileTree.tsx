...
function FileTreeNode({ node, depth, gitStatusMap }: FileTreeNodeProps) {
  ...
  if (node.isDir) {
    return (
      <div>
        <button
          className="flex items-center w-full text-left py-0.5 px-1 hover:bg-accent/50 rounded-sm text-xs gap-1"
  ...
  return (
    <button
      className={`flex items-center w-full text-left py-0.5 px-1 rounded-sm text-xs gap-1 ${
