  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        description ? "flex-col items-start gap-0.5" : "items-center gap-2 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
      <span
        ...
        className="absolute right-2 top-2 flex size-3.5 items-center justify-center"
      >
      ...
      {description && (
        <span className="text-muted-foreground text-xs leading-snug line-clamp-2 pr-4">
          {description}
        </span>
      )}
    </SelectPrimitive.Item>
