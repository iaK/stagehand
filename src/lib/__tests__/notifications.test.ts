...
describe("registerNotificationClickHandler", () => {
  ...
  it("navigates to correct project and task when extra contains both", async () => {
    ...
    const mockTask: Task = { id: "task-1", title: "Test Task", description: null, status: "pending", project_id: "proj-1", current_stage_id: null, branch_name: null, worktree_path: null, pr_url: null, parent_task_id: null, target_branch: null, ejected: 0, lifecycle: "active", diff_insertions: null, diff_deletions: null, created_at: "", updated_at: "" };
