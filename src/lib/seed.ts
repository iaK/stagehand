...
export function getDefaultStageTemplates(
  ...
  return [
    ...
    },
    {
      ...
      agent: null,
      commits_changes: 1,
      can_follow: JSON.stringify(["Implementation"]),
    },
    {
      id: crypto.randomUUID(),
      project_id: projectId,
      ...
      agent: null,
      commits_changes: 1,
      can_follow: JSON.stringify(["Implementation", "Refinement"]),
    },
    {
      id: crypto.randomUUID(),
      project_id: projectId,
      ...
      requires_user_input: 0,
      agent: null,
      can_follow: JSON.stringify(["Implementation", "Refinement", "Security Review"]),
    },
    {
      id: crypto.randomUUID(),
      project_id: projectId,
